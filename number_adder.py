# Create a function that will add up all the numbers on a
# list of numbers that were given as an argument
# Use this function to aks the user for aseries of number
